                    ...
                    <div class="d-flex align-items-center mb-3">
                        <div>
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('admin.designation.index') }}">Manage Office</a></li>
                                <li class="breadcrumb-item active">Edit Office</li>
                            </ul>

                            <h1 class="page-header mb-0">Edit Office</h1>
                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group form-check form-switch mt-4">
                                            ...
                                            <input type="checkbox" class="form-check-input" id="status" name="status" value="1" @if($office->status == 1) checked @endif/>
                                        </div>
                                    </div>
