                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-2">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="post_code" name="post_code" placeholder="Enter your current post code / CAP" value="{{old('post_code')}}" />
                        </div>
                    </div>

                    <div class="col-md-4 mb-2">
                        <div class="form-group">
                            <label for="ciry" class="form-label">City / Citta:</label>
                            <input type="text" class="form-control" id="ciry" name="ciry" placeholder="Enter your current ciry" value="{{old('ciry')}}" />
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 mb-2">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="province" name="province" placeholder="Enter your current province / Prov" value="{{old('province')}}" />
                        </div>
                    </div>
