...
<div id="content" class="app-content">
    ...
    <div class="d-flex align-items-center mb-3">
        ...
        <div class="ms-auto">
            <a href="{{route('admin.clientInfo.create')}}" class="btn btn-outline-theme"><i class="fa fa-plus-circle fa-fw me-1"></i> Add New Application Type</a>
            <a href="#" class="btn btn-outline-theme"><i class="fa fa-plus-circle fa-fw me-1"></i> Add New Application</a>
        </div>
    </div>
    <hr>
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="form-group mb-3">
                    <label class="form-label" for="name">Search Application Type</label>
